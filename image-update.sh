...
STACK_NAME="containerised-giftcard-checker-stack"
TEMPLATE_FILE="template.yaml"
FUNCTION_NAME="dockerised-giftcard-tracker"
IMAGE_URI="xxxxxxxx.dkr.ecr.eu-west-1.amazonaws.com/containerised-giftcard-checker:latest"
...
cd ../ #
docker build -t containerised-giftcard-checker -f giftcardsdocker/Dockerfile .

docker tag containerised-giftcard-checker:latest xxxxxxxx.dkr.ecr.eu-west-1.amazonaws.com/containerised-giftcard-checker:latest

docker push xxxxxxxx.dkr.ecr.eu-west-1.amazonaws.com/containerised-giftcard-checker:latest
